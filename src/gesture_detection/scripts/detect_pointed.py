...
class PointedGestureCmd(py_trees.behaviour.Behaviour):
    """
    Node Name :
        * node name *
    Client :
    ...
    print("init_work1")
    def __init__(self):
        super(PointedGestureCmd,self).__init__()
    ...
    def setup(self,**kwargs):
        ...
        self.enable_client = self.node.create_client(Empty,'/detect_pointed/enable')
        self.topic_subscription = self.node.create_subscription(Int8,'/detect_pointed/detected',self.subscription_callback, qos_profile = 10)                                                                                                                    
